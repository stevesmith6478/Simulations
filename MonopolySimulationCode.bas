    ...
    For Z = 1 To intTests
        ...
        For intMove = 1 To intMovesPerTest
            ...
            If varPlayerData(intActivePlayer, 5) = "Inmate" Then
                ...
                End If
            Else
                If varPlayerData(intActivePlayer, 3) + intDiceRoll > 39 Then ' Player passes Go
            ...
            If blnDouble = True Then
                If varPlayerData(intActivePlayer, 4) = 2 Then 'Three doubles in a row - Player goes to jail
            ...
            ElseIf varPlayerData(intActivePlayer, 5) = "Inmate" Then
                ...
                End If
            End If
        Next 'this is a next without for
    Next
